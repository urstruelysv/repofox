...
export const BranchIcon = ({ className }: { className?: string }) => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const RevertIcon = ({ className }: { className?: string }) => (
...
// Convenience object used by the animated Sidebar demo component
export const Icons = {
  check: <CheckIcon />,
  play: <PlayIcon />,
  chevron: <ChevronIcon />,
