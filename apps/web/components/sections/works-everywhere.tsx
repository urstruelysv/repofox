...
const TABS: Tab[] = [
  {
    ...
    action: {
      label: "Download VSIX",
      href: "https://github.com/repofox/repofox/releases",
      mono: false,
    },
    secondary: {
  ...
  },
  {
    ...
    secondary: {
      ...
      href: "https://github.com/repofox/repofox",
    },
  ...
  return (
    <div className="p-5 min-h-[340px] font-mono text-[12.5px] leading-[1.75] bg-pop-gray-100 text-pop-black">
      {[
        ...
        { c: "", t: "" },
        { c: "var(--pop-blue)", t: "  ▸ Generating branch name…" },
        ...
        { c: "", t: "" },
        { c: "var(--pop-blue)", t: "  ▸ Generating commit message…" },
